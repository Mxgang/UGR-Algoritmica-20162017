...
int main(int argc, char* argv[])
{
  ...
  //Se recibe por parámetro el número de elementos a utilizar por el algoritmo
  if (argc != 2)
  {
  ...
  //Se inicializa el tiempo antes de empezar el algoritmo
  tantes = high_resolution_clock::now();
  
  quicksort(T, n);
  //Se inicializa el tiempo despues de terminar el algoritmo
  tdespues = high_resolution_clock::now();
  //Se calcula el tiempo total transcurrido durante la ejecución del algoritmo
  transcurrido = duration_cast<duration<double>>(tdespues - tantes);
  //Se da como salida el número de elementos utilizados y el tiempo transcurrido
